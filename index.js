...
function findElementGreaterThan(arr, num) {
  ...
  let findEven = arr.find((element) => element > num);
  return findEven;
...
function findIndexByProperty(arr, name) {
  ...
  let index = arr.findIndex((element) => (element.arr = name));
  return index;
...
function findLastEvenNumber(arr) {
  ...
  let lastEven = arr.findLast((num) => num % 2 === 0);
  return lastEven;
...
function getPositiveArrayValues(arr) {
  ...
  let FromN = Array.from(arr.values());
  // return FromN;

  let filterN = FromN.filter((num) => num > 0);
  return filterN;
  // console.log(filterN(elem));
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function removeAndDouble(arr, startIdx) {
  ...
  let spliceN = arr.splice(startIdx);
  // return arr;
  let mapN = arr.map((num) => num * 2);
  return mapN;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  let flatN = arr.flat();
  // return flatN;
  let mapN = flatN.map((x) => x * x);
  // return mapN;
  let filterN = mapN.filter((num) => num > threshold);
  return filterN;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  let sliceN = arr.slice(n);
  // return sliceN;

  let N = 0;
  const sum = sliceN.reduceRight(
    (accumulator, currentvalue) => accumulator + currentvalue,
    N
  );

  sliceN.forEach((element) => console.log(element));
  return sum;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
...
function expandArrayByN(arr, n) {
  ...
  let flatMapN = arr.flatMap((num) => (num === num ? [num, num, num] : n));
  return flatMapN;
...
function findLastNegativeNumberIndex(arr) {
  ...
  let findLastN = arr.findLastIndex(function (elem) {
    return elem < 0;
  });
  return findLastN;
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо -1
